...
var func1 = () => {
  console.log(
    'func1 will be initialized as a variable in memory instead of function as it is an arrow function!!'
  )
}

var func2 = function () {
  console.log(
    'func2 will be declared as a variable in memory instead of function!!'
  )
}
